...
python3 OPTIM-FRAMEWORK/I-INTELLIGENT/setup_ampel360.py

# 3. Check configuration status
python3 OPTIM-FRAMEWORK/I-INTELLIGENT/ampel360_utils.py --status --validate
...
- **Utilities**: `OPTIM-FRAMEWORK/I-INTELLIGENT/ampel360_utils.py` - Configuration management utilities
- **Setup Script**: `OPTIM-FRAMEWORK/I-INTELLIGENT/setup_ampel360.py` - Complete framework setup and demonstration
...
- **Feasible set**: `OPTIM-FRAMEWORK/I-INTELLIGENT/feasible_set.json` (post‑enumeración)  
